...
public class EmployeeController {
    ...
    @PostMapping("/filter")
    public ResponseEntity<List<EmployeeDetailResponse>> filterEmployees(@RequestBody EmployeeSkillFilterRequest request) {
        return ResponseEntity.ok(employeeService.filterEmployeesBySkills(request));
    }
